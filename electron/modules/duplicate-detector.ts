 ...
 * Es. `-Users-…-Documents-Acme2-0` → ['documentsacme20', 'acme20', '0'].
 * Serve a riconoscere che `…-Documents-Acme2-0` è lo stesso progetto di `Acme2.0`
 * (→ 'acme20'), nonostante l'hash lossy non permetta di ricostruirne il basename.
 */
