      ...
      <div className="flex-1 overflow-y-auto">
        <section className="cl-hero">
          ...
          <h1 className="cl-h-name static">
            ...
            <span className="glyph" style={{ color: 'var(--cl-violet)' }}>
              .
            </span>
          </h1>
        ...
        <form
          ...
          style={{ paddingTop: 24, paddingBottom: 80, maxWidth: 1180 }}
        >
          <div className="grid items-start gap-x-12 gap-y-8 xl:grid-cols-[minmax(0,1fr)_400px]">
            <div className="space-y-5">
              ...
              <div>
                <label className={labelCls}>
                  <span>Content · System Prompt</span>{' '}
                  <span className="text-[var(--cl-violet)] ml-1">*</span>
                ...
                {contentTab === 'edit' ? (
                  <textarea
                    className={
                      inputCls + ' min-h-[460px] resize-y font-mono text-[12px] leading-relaxed'
                    }
                  ...
                  <div className="w-full min-h-[460px] border border-[var(--cl-line)] bg-[var(--cl-paper)] px-4 py-3 overflow-y-auto">
                    {form.content.trim() ? (
                      ...
                      <p className="font-mono text-[12px] text-[var(--cl-ink-4)]">
            ...
            <aside className="border-t border-[var(--cl-line-soft)] pt-5 xl:border-t-0 xl:border-l xl:pt-0 xl:pl-10">
              <div className="font-mono text-[10px] uppercase tracking-[0.20em] text-[var(--cl-ink-4)] mb-4">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    className={inputCls}
                    placeholder="commit-helper, test-runner"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.mcpServersRaw}
                    onChange={e => set('mcpServersRaw', e.target.value)}
                  />
                </div>
              </div>
            </aside>
          ...
          {error && (
            <p className="font-mono text-[11px] text-[var(--cl-danger)] border border-[var(--cl-danger)] bg-[var(--cl-danger-soft)] px-3 py-2">
              {error}
            </p>
          )}

          <div className="pt-4 mt-4 border-t border-[var(--cl-line-soft)] flex items-center justify-end gap-3">
            <span className="mr-auto font-mono text-[10px] text-[var(--cl-ink-4)]">
              ⌘↵ to save · esc to cancel
            </span>
            <button type="button" onClick={onBack} className="cl-btn">
              Cancel
            </button>
            <button
              type="submit"
              ...
              style={{
                opacity: !canSubmit || createAgent.isPending ? 0.4 : 1,
                cursor: !canSubmit || createAgent.isPending ? 'not-allowed' : 'pointer',
              }}
            >
