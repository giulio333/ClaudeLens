    ...
    <div className="h-full flex flex-col" style={{ background: 'var(--cl-paper)' }}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <form
          ...
          style={{ paddingTop: 24, paddingBottom: 80, maxWidth: 1120 }}
        >
          <div className="grid items-start gap-x-12 gap-y-8 xl:grid-cols-[minmax(0,1fr)_310px]">
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  className={inputCls}
                  placeholder="Generates structured commit messages"
              ...
              <div>
                <label className={labelCls}>
                  <span>Content · SKILL.md</span>{' '}
                  <span className="text-[var(--cl-accent)] ml-1">*</span>
                ...
                {contentTab === 'edit' ? (
                  <textarea
                    className={
                      inputCls + ' min-h-[340px] resize-y font-mono text-[12px] leading-relaxed'
                    }
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="font-mono text-[12px] text-[var(--cl-ink-2)]">
                      {form.fork ? 'Run in forked subagent' : 'Run inline'}
                    </span>
                  </button>
                </div>
                {form.fork && (
          ...
          <div className="pt-4 mt-4 border-t border-[var(--cl-line-soft)] flex items-center justify-end gap-3">
            ...
            <button
              ...
              style={{
                opacity: !canSubmit || createSkill.isPending ? 0.4 : 1,
                cursor: !canSubmit || createSkill.isPending ? 'not-allowed' : 'pointer',
              }}
            >
