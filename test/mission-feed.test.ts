...
Links: [{"title":"A","url":"https://www.vitest.dev/a"},{"title":"B","url":"https://www.docs.example/b"},{"title":"C","url":"https://migration.org/c"},{"title":"D","url":"https://www.vitest.dev/d"}]
...
describe('mission feed — web activity', () => {
  ...
  it('carries a search by its query, its result count and its sources', () => {
    ...
    expect(event).toMatchObject({
      ...
      meta: 'vitest.dev · docs.example · +1',
      expandable: false,
    });
  });
