...
Links: [{"title":"Rinnovo guide Vitest-migration, i nuovi minimi in vigore","url":"https://www.pmi.it/economia/lavoro/495251/rinnovo.html"},{"title":"guide Vitest-migration - Uilm","url":"https://www.docs.example/contratti-nazionali/guide/"},{"title":"migration","url":"https://www.pmi.it/altro/2026/riepilogo.html"}]
...
Redirect URL (from the server's Location header — server-supplied, not verified): http://www.example.com/home
Status: 301 Moved Permanently
...
describe('web — search results', () => {
  ...
  it('keeps quotes that belong to the query itself', () => {
    const raw = 'Web search results for query: ""Vitest" migration 2028"\n\nLinks: []';
    expect(parseWebSearchResult(raw).query).toBe('"Vitest" migration 2028');
  });
