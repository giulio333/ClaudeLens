...
- Per ogni modulo elenca: responsabilità principale, funzioni esportate, dipendenze da filesystem (`~/.Codex/`)
- Segnala moduli con funzioni che superano 50 righe (violazione convenzione AGENTS.md)
